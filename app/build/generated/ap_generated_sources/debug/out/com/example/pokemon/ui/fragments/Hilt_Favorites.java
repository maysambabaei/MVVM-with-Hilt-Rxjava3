...
abstract class Hilt_Favorites extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_Favorites(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((Favorites_GeneratedInjector) generatedComponent()).injectFavorites(UnsafeCasts.<Favorites>unsafeCast(this));
  }
