...
abstract class Hilt_Home extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_Home(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((Home_GeneratedInjector) generatedComponent()).injectHome(UnsafeCasts.<Home>unsafeCast(this));
  }
