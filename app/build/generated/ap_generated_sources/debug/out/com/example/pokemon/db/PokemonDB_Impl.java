  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `favorite_table` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT, `url` TEXT)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '06cded71bd70c99b87e8793cad487cfa')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsFavoriteTable = new HashMap<String, TableInfo.Column>(3);
        _columnsFavoriteTable.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsFavoriteTable.put("name", new TableInfo.Column("name", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsFavoriteTable.put("url", new TableInfo.Column("url", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoFavoriteTable.equals(_existingFavoriteTable)) {
          return new RoomOpenHelper.ValidationResult(false, "favorite_table(com.example.pokemon.model.Pokemon).\n"
                  + " Expected:\n" + _infoFavoriteTable + "\n"
                  + " Found:\n" + _existingFavoriteTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "06cded71bd70c99b87e8793cad487cfa", "c1e3450d6c9f4fc134688ef53ba1e4a9");
